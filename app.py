...
N_24h       = st.number_input('N_24h', min_value=0.0, max_value=100.0)
WBC_24h     = st.number_input('WBC_24h', min_value=0.0, max_value=30.0)
L_24h       = st.number_input('L_24h', min_value=0.0, max_value=80.0)
...
input_features = np.array([[NIHSS_24h, N_24h, WBC_24h, L_24h, LOS, Ddimer]])

# List the feature names corresponding to the input features
feature_names = ['NIHSS_24h', 'N_24h', 'WBC_24h', 'L_24h', 'LOS', 'Ddimer']
